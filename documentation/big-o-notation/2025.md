...
- **O(R×C)**: Day4 Part 1 ✅, Day6 Part 1 ✅, Day6 Part 2 ✅
- **O((R×C)²)**: Day4 Part 2 ✅
- **O(I×R)**: Day5 Part 1 ✅
...
- `countNeighbors()` checks 8 adjacent cells (including diagonals) using `NEIGHBOR_DIRECTIONS` in O(1) time
- `findCellsToRemove()` uses `findAll()` to get all '@' cells, then streams and filters by neighbor count
