 ...
 * 
 * An IP supports TLS if it has an Autonomous Bridge Bypass Annotation (ABBA).
...
public class Day7 implements Day<Integer> {
     ...
     */
    private boolean containsABBA(String text) {
     ...
     */
    private List<String> findABAPatterns(String text) {
     ...
     */
    private String abaToBAB(String aba) {
        if (aba.length() != 3) {
