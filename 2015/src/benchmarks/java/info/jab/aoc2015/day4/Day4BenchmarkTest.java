 ...
 * Enable with: mvn test -D2015-day4-benchmark=true -Dsurefire.failIfNoSpecifiedTests=false -pl 2015 -am
 */
@DisabledIf(
    name = "2015-day4-benchmark",
    value = "false",
    reason = "Benchmark tests are disabled by default. Enable with: mvn test -D2015-day4-benchmark=true -Dsurefire.failIfNoSpecifiedTests=false -pl 2015 -am"
)
class Day4BenchmarkTest {

    @Test
    void should_benchmark_day4() throws RunnerException {
