 ...
 * Enable with: mvn test -D2015-day5-benchmark=true -Dsurefire.failIfNoSpecifiedTests=false -pl 2015 -am
 */
@DisabledIf(
    name = "2015-day5-benchmark",
    value = "false",
    reason = "Benchmark tests are disabled by default. Enable with: mvn test -D2015-day5-benchmark=true -Dsurefire.failIfNoSpecifiedTests=false -pl 2015 -am"
)
class Day5BenchmarkTest {

    @Test
    void should_benchmark_day5() throws RunnerException {
