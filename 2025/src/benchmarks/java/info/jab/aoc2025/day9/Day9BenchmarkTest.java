 ...
 * Enable with: mvn test -D2025-day9-benchmark=true -Dsurefire.failIfNoSpecifiedTests=false -pl 2025 -am
 */
@DisabledIf(
    name = "2025-day9-benchmark",
    value = "false",
    reason = "Benchmark tests are disabled by default. Enable with: mvn test -D2025-day9-benchmark=true -Dsurefire.failIfNoSpecifiedTests=false -pl 2025 -am"
)
